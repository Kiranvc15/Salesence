...
export default function Login() {
  ...
  const inspirationalThoughts = [
    {
      text: "Your career journey begins with a single step",
      icon: TrendingUp,
      color: "text-blue-400"
    },
    {
      text: "Great insights lead to greater opportunities",
      icon: Lightbulb,
      color: "text-yellow-400"
    },
    {
      text: "Data-driven decisions create exceptional careers",
      icon: BarChart3,
      color: "text-green-400"
    },
    {
      text: "The right analysis can reveal your true potential",
      icon: Star,
      color: "text-purple-400"
    },
    {
      text: "Every professional journey deserves intelligent guidance",
      icon: Brain,
      color: "text-pink-400"
    }
  ];
            ...
            <div className="bg-gray-950/90 rounded-t-2xl">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-gray-400 mt-2">
                  {applyingFor ? "Login to apply for this position" :
                   forgotStep === 1
          ...
          <CardContent className="pt-6">
            {status === "success" && forgotStep === 0 ? (
              ...
              >
                ...
                {applyingFor && (
                  <p className="text-blue-300 text-sm">Preparing your application for {applyingFor}</p>
                )}
              </motion.div>
            ) : forgotStep === 1 ? (
              // Step 1: Enter Email
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-500 hover:to-pink-400 text-white font-semibold rounded-xl py-5 transition-all duration-300 transform hover:scale-[1.02]">
                  {applyingFor ? "Login & Apply" : "Log In"}
                </Button>
              </form>
            )}
      ...
      >
        <div className="bg-black/30 backdrop-blur-md rounded-2xl p-5 border border-white/10">
          ...
          <div className="pt-4 border-t border-white/10">
            <h4 className="font-semibold text-white mb-3 text-sm">Quick Navigation</h4>
          ...
          <div className="mt-5 p-3 bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-lg border border-purple-500/20">
            <p className="text-xs text-purple-300 font-medium">New to Salesence?</p>
            <p className="text-xs text-gray-400 mt-1">Create an account to unlock all features</p>
            <Button 
