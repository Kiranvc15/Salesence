          ...
          <CardContent className="pt-6">
            {status === "success" ? (
              ...
              >
                ...
                <p className="text-gray-300">Signup successful! Redirecting...</p>
              </motion.div>
            ) : (
      ...
      >
        <div className="bg-black/40 backdrop-blur-lg rounded-xl p-8 border border-white/10 shadow-xl">
          <div className="text-center mb-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Why Join Our Platform?</h3>
            <p className="text-gray-400">Designed for professionals across industries</p>
          </div>
          
          <div className="space-y-4">
            {[
              { icon: <Shield className="h-4 w-4 text-purple-400" />, text: "Enterprise-grade security" },
              { icon: <Zap className="h-4 w-4 text-purple-400" />, text: "Lightning fast performance" },
              { icon: <Globe className="h-4 w-4 text-purple-400" />, text: "Global accessibility" },
              { icon: <Users className="h-4 w-4 text-purple-400" />, text: "Collaborative features" }
            ].map((feature, index) => (
              <motion.div 
                key={index}
